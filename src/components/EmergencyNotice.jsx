...
export default function EmergencyNotice({ isVisible, onClose, onRetryClientMode, targetUrl }) {
  ...
  return (
    <div className="fixed inset-x-4 bottom-6 z-50 max-w-xl mx-auto animate-fade-in">
      <div className="glass-panel p-4 sm:p-5 rounded-2xl border-white/30 bg-zinc-950/95 shadow-2xl flex items-start gap-4">
        
        <div className="w-9 h-9 rounded-xl bg-white text-black flex items-center justify-center flex-shrink-0 font-bold">
          <AlertCircle className="w-5 h-5" />
        </div>

        <div className="flex-1 space-y-1.5">
          <div className="flex items-center justify-between">
            <h4 className="font-bold text-white text-sm">Mode Cadangan Aktif (Client Direct)</h4>
          ...
          <div className="pt-2 flex items-center gap-3">
            <button
              ...
              className="btn-primary py-1.5 px-3 text-xs font-bold rounded-lg flex items-center gap-1.5"
            >
